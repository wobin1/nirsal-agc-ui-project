...
@Component({
  selector: 'ps-farmers-allocation',
  templateUrl: './farmers-allocation.component.html',
  styleUrls: ['./farmers-allocation.component.scss']
})
export class FarmersAllocationComponent implements OnInit {
  stageIds: any = {
